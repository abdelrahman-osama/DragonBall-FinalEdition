...
public class Battle implements Serializable{
	...
	public void play() {
		if (new Random().nextInt(100) > 15) {
			...
			try {
				...
				} catch (NotEnoughKiException | AlreadyTransformedException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
			}
	...
	public void attack(Attack attack) throws NotEnoughKiException, AlreadyTransformedException {
		...
		ArrayList <Attack> randomAttack = getAssignedAttacks();
		Attack att = randomAttack.get(new Random().nextInt(randomAttack.size()));
		attack(att);
